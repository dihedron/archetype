...
// linker flag:
//   $> go build -ldflags "-X github.com/dihedron/go-archetype/metadata.GitHash=$(hash)"
...
//   $> nm ./dist/linux/amd64/go-archetype | grep GitHash
//   00000000015db9c0 b github.com/dihedron/go-archetype/metadata.GitHash
